          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-xl">
            ...
            <div className="flex gap-4 justify-center mb-6">
              <button
                ...
                disabled={!account || isDecrementing || isLoadingCount || !contractVerified}
              ...
              <button
                ...
                disabled={!account || isIncrementing || isLoadingCount || !contractVerified}
                className={`flex-1 font-semibold py-3 px-6 rounded-lg transition-colors duration-200 flex items-center justify-center gap-2 ${
                  !account || !contractVerified
                    ? 'bg-gray-300 text-gray-500 cursor-not-allowed dark:bg-gray-600 dark:text-gray-400'
            ...
            <div className="text-center text-sm text-gray-500 dark:text-gray-400">
              {!account ? (
                ...
                <div>
                  ...
                  <p className="text-xs">
                    {contractVerificationError || 'Unable to verify contract deployment'}
                  </p>
                </div>
              ) : (
                <div>
